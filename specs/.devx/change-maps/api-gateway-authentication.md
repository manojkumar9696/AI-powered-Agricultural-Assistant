# Change Map - RESTful API Integration Framework
...
- Feature slug: `api-gateway-authentication`
...
- `specs/.devx/change-maps/api-gateway-authentication.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/api-gateway-authentication/specs.md`
- `specs/api-gateway-authentication/requirements.md`
- `specs/api-gateway-authentication/prompt.md`
