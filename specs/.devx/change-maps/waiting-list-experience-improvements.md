# Change Map - What are archived ideas?; New rewards program; Express checkout (+41 more)
...
- Feature slug: `waiting-list-experience-improvements`
...
- `specs/.devx/change-maps/waiting-list-experience-improvements.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/waiting-list-experience-improvements/specs.md`
- `specs/waiting-list-experience-improvements/requirements.md`
- `specs/waiting-list-experience-improvements/prompt.md`
